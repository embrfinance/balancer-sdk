(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ethersproject/abi'), require('@ethersproject/constants'), require('@ethersproject/bignumber'), require('@ethersproject/address'), require('@ethersproject/bytes'), require('@ethersproject/abstract-signer'), require('@ethersproject/contracts'), require('@balancer-labs/sor'), require('lodash'), require('axios'), require('@ethersproject/providers'), require('graphql-request'), require('graphql')) :
    typeof define === 'function' && define.amd ? define(['exports', '@ethersproject/abi', '@ethersproject/constants', '@ethersproject/bignumber', '@ethersproject/address', '@ethersproject/bytes', '@ethersproject/abstract-signer', '@ethersproject/contracts', '@balancer-labs/sor', 'lodash', 'axios', '@ethersproject/providers', 'graphql-request', 'graphql'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["balancer-js"] = {}, global.abi, global.constants, global.bignumber, global.address, global.bytes, global.abstractSigner, global.contracts, global.sor, global.lodash, global.axios, global.providers, global.graphqlRequest, global.graphql));
})(this, (function (exports, abi, constants, bignumber, address, bytes, abstractSigner, contracts, sor, lodash, axios, providers, graphqlRequest, graphql) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    const PoolTokenFragmentDoc = gql$1 `
    fragment PoolToken on PoolToken {
  id
  symbol
  name
  decimals
  ...
  upperTarget
    ...
    const PoolWithoutLinearFragmentDoc = gql$1 `
    fragment PoolWithoutLinear on Pool {
  id
  address
  poolType
  symbol
  ...
  swapEnabled
    ...
    ${PoolTokenFragmentDoc}`;
    const PoolSnapshotFragmentDoc = gql$1 `
  ...
  timestamp
    ...
    `;
    const JoinExitFragmentDoc = gql$1 `
  ...
  users(
    ...
    exports.BalancersDocument = BalancersDocument;
    exports.JoinExitFragmentDoc = JoinExitFragmentDoc;
    exports.JoinExitsDocument = JoinExitsDocument;
    exports.ManagedPoolEncoder = ManagedPoolEncoder;
    exports.PoolDocument = PoolDocument;
    exports.PoolFragmentDoc = PoolFragmentDoc;
    exports.PoolHistoricalLiquiditiesDocument = PoolHistoricalLiquiditiesDocument;
    exports.PoolSnapshotFragmentDoc = PoolSnapshotFragmentDoc;
    exports.PoolSnapshotsDocument = PoolSnapshotsDocument;
    exports.PoolTokenFragmentDoc = PoolTokenFragmentDoc;
    exports.PoolWithoutLinearDocument = PoolWithoutLinearDocument;
    exports.PoolWithoutLinearFragmentDoc = PoolWithoutLinearFragmentDoc;
    exports.PoolsDocument = PoolsDocument;
    exports.PoolsWithoutLinearDocument = PoolsWithoutLinearDocument;
    ...
    exports.SubgraphBalancerFragmentDoc = SubgraphBalancerFragmentDoc;
    exports.SubgraphTokenLatestPriceFragmentDoc = SubgraphTokenLatestPriceFragmentDoc;
    exports.SubgraphTokenPriceFragmentDoc = SubgraphTokenPriceFragmentDoc;
    exports.SubgraphUserFragmentDoc = SubgraphUserFragmentDoc;
    exports.SwapsService = SwapsService;
    exports.TokenLatestPriceDocument = TokenLatestPriceDocument;
    exports.TokenLatestPricesDocument = TokenLatestPricesDocument;
    exports.TokenPricesDocument = TokenPricesDocument;
