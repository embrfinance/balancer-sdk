...
async function getSorSwapInfo(tokenIn, tokenOut, swapType, amount, sor) {
    const swapTypeSOR = swapType === SwapType.SwapExactIn ? SwapTypes.SwapExactIn : SwapTypes.SwapExactOut;
...
class BalancerSDK {
    constructor(config) {
        ...
        this.provider = (_a = config.provider) !== null && _a !== void 0 ? _a : new JsonRpcProvider(this.rpcUrl);
