(function (global, factory) {
    ...
    */
    async function getSorSwapInfo(tokenIn, tokenOut, swapType, amount, sor$1) {
        const swapTypeSOR = swapType === exports.SwapType.SwapExactIn ? sor.SwapTypes.SwapExactIn : sor.SwapTypes.SwapExactOut;
  ...
  sharesOwned(first: 1000) {
    ...
    `;
    const SubgraphPoolsDocument = gql$1 `
    query SubgraphPools($skip: Int, $first: Int, $orderBy: Pool_orderBy, $orderDirection: OrderDirection, $where: Pool_filter, $block: Block_height) {
  pools(
    skip: $skip
    first: $first
    orderBy: $orderBy
    ...
    const SubgraphPoolDocument = gql$1 `
    query SubgraphPool($id: ID!, $block: Block_height) {
  pool(id: $id, block: $block) {
    ...SubgraphPool
  }
}
    ${SubgraphPoolFragmentDoc}`;
    const SubgraphPoolsWithoutLinearDocument = gql$1 `
    query SubgraphPoolsWithoutLinear($skip: Int, $first: Int, $orderBy: Pool_orderBy, $orderDirection: OrderDirection, $where: Pool_filter, $block: Block_height) {
  pools(
    skip: $skip
    first: $first
    orderBy: $orderBy
    ...
    const SubgraphPoolWithoutLinearDocument = gql$1 `
    query SubgraphPoolWithoutLinear($id: ID!, $block: Block_height) {
  pool(id: $id, block: $block) {
    ...SubgraphPoolWithoutLinear
  }
}
    ${SubgraphPoolWithoutLinearFragmentDoc}`;
    const SubgraphPoolHistoricalLiquiditiesDocument = gql$1 `
    query SubgraphPoolHistoricalLiquidities($skip: Int, $first: Int, $orderBy: PoolHistoricalLiquidity_orderBy, $orderDirection: OrderDirection, $where: PoolHistoricalLiquidity_filter, $block: Block_height) {
  poolHistoricalLiquidities(
    ...
    `;
    const SubgraphPoolSnapshotsDocument = gql$1 `
    query SubgraphPoolSnapshots($skip: Int, $first: Int, $orderBy: PoolSnapshot_orderBy, $orderDirection: OrderDirection, $where: PoolSnapshot_filter, $block: Block_height) {
  poolSnapshots(
    skip: $skip
    first: $first
    orderBy: $orderBy
    ...
    const SubgraphJoinExitsDocument = gql$1 `
    query SubgraphJoinExits($skip: Int, $first: Int, $orderBy: JoinExit_orderBy, $orderDirection: OrderDirection, $where: JoinExit_filter, $block: Block_height) {
  joinExits(
    skip: $skip
    first: $first
    orderBy: $orderBy
    ...
    const SubgraphBalancersDocument = gql$1 `
    query SubgraphBalancers($skip: Int, $first: Int, $orderBy: Balancer_orderBy, $orderDirection: OrderDirection, $where: Balancer_filter, $block: Block_height) {
  balancers(
    skip: $skip
    first: $first
    orderBy: $orderBy
    ...
    const SubgraphTokenPricesDocument = gql$1 `
    query SubgraphTokenPrices($skip: Int, $first: Int, $orderBy: TokenPrice_orderBy, $orderDirection: OrderDirection, $where: TokenPrice_filter, $block: Block_height) {
  tokenPrices(
    skip: $skip
    first: $first
    orderBy: $orderBy
    ...
    const SubgraphTokenLatestPricesDocument = gql$1 `
    query SubgraphTokenLatestPrices($skip: Int, $first: Int, $orderBy: LatestPrice_orderBy, $orderDirection: OrderDirection, $where: LatestPrice_filter, $block: Block_height) {
  latestPrices(
    skip: $skip
    first: $first
    orderBy: $orderBy
    ...
    const SubgraphTokenLatestPriceDocument = gql$1 `
    query SubgraphTokenLatestPrice($id: ID!) {
  latestPrice(id: $id) {
    ...SubgraphTokenLatestPrice
  }
}
    ${SubgraphTokenLatestPriceFragmentDoc}`;
    const SubgraphUserDocument = gql$1 `
    query SubgraphUser($id: ID!, $block: Block_height) {
  user(id: $id, block: $block) {
    ...SubgraphUser
  }
}
    ${SubgraphUserFragmentDoc}`;
    const SubgraphUsersDocument = gql$1 `
    query SubgraphUsers($skip: Int, $first: Int, $orderBy: User_orderBy, $orderDirection: OrderDirection, $where: User_filter, $block: Block_height) {
  users(
    skip: $skip
    first: $first
    orderBy: $orderBy
    ...
    function getSdk(client, withWrapper = defaultWrapper) {
        return {
            SubgraphPools(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphPoolsDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphPools');
            },
            SubgraphPool(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphPoolDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphPool');
            },
            SubgraphPoolsWithoutLinear(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphPoolsWithoutLinearDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphPoolsWithoutLinear');
            },
            SubgraphPoolWithoutLinear(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphPoolWithoutLinearDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphPoolWithoutLinear');
            },
            SubgraphPoolHistoricalLiquidities(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphPoolHistoricalLiquiditiesDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphPoolHistoricalLiquidities');
            },
            SubgraphPoolSnapshots(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphPoolSnapshotsDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphPoolSnapshots');
            },
            SubgraphJoinExits(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphJoinExitsDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphJoinExits');
            },
            SubgraphBalancers(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphBalancersDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphBalancers');
            },
            SubgraphTokenPrices(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphTokenPricesDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphTokenPrices');
            },
            SubgraphTokenLatestPrices(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphTokenLatestPricesDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphTokenLatestPrices');
            },
            SubgraphTokenLatestPrice(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphTokenLatestPriceDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphTokenLatestPrice');
            },
            SubgraphUser(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphUserDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphUser');
            },
            SubgraphUsers(variables, requestHeaders) {
                return withWrapper((wrappedRequestHeaders) => client.request(SubgraphUsersDocument, variables, { ...requestHeaders, ...wrappedRequestHeaders }), 'SubgraphUsers');
            }
        };
    }
    ...
    class SorFactory {
        static createSor(network, sorConfig, provider, subgraphClient) {
    ...
    class BalancerSDK {
        constructor(config) {
            ...
            this.provider = (_a = config.provider) !== null && _a !== void 0 ? _a : new providers.JsonRpcProvider(this.rpcUrl);
            this.subgraphClient = createSubgraphClient(this.network.subgraphUrl);
            const sorConfig = this.getSorConfig(config);
            this.sor = SorFactory.createSor(this.network, sorConfig, this.provider, this.subgraphClient);
